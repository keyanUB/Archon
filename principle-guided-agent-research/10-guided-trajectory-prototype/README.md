...
[`comparison.generated.json`](artifacts/comparison.generated.json).
...
RUN_DIR=principle-guided-agent-research/10-guided-trajectory-prototype/artifacts/runs/2026-07-27-zip-prototype

python3 principle-guided-agent-research/10-guided-trajectory-prototype/evaluator/evaluate_zip_inspector.py \
...
python3 principle-guided-agent-research/10-guided-trajectory-prototype/evaluator/summarize_trajectories.py \
  "$RUN_DIR" \
